(function () {
  ...
  function presetIcon(kind) {
    var icons = {
      slow: './assets/presets/ralentir.png',
      calm: './assets/presets/retrouver-calme.png',
      balance: './assets/presets/equilibre.png',
      energy: './assets/presets/retrouver-dynamisme.png',
      dynamic: './assets/presets/dynamiser.png'
    };
    var src = icons[kind] || icons.balance;
    return '<span class="v60-preset-icon v64-icon v64-icon-' + kind + '">' +
      '<img class="v83-preset-image" src="' + src + '" alt="" aria-hidden="true" draggable="false">' +
    '</span>';
  }
