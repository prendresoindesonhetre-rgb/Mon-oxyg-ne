...
public class MainActivity extends Activity {
    private static final String APP_URL = "https://kzviewbnnnzdyocdjtah.supabase.co/functions/v1/regie-app";
...
print('V14 secure wrapper applied')
